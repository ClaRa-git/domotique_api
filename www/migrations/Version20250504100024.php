 ...
 */
final class Version20250504100024 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE feature (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(50) NOT NULL, minimum INT DEFAULT NULL, maximum INT DEFAULT NULL, unit_id INT DEFAULT NULL, device_type_id INT DEFAULT NULL, INDEX IDX_1FD77566F8BD700D (unit_id), INDEX IDX_1FD775664FFA550E (device_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE song (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(50) NOT NULL, artist VARCHAR(50) NOT NULL, duration INT NOT NULL, file_path VARCHAR(255) NOT NULL, image_path VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE device_type ADD CONSTRAINT FK_5E78213F77FB932 FOREIGN KEY (protocole_id) REFERENCES protocole (id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE feature ADD CONSTRAINT FK_1FD77566F8BD700D FOREIGN KEY (unit_id) REFERENCES unit (id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE feature ADD CONSTRAINT FK_1FD775664FFA550E FOREIGN KEY (device_type_id) REFERENCES device_type (id)
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE device_type DROP FOREIGN KEY FK_5E78213F77FB932
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE feature DROP FOREIGN KEY FK_1FD77566F8BD700D
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE feature DROP FOREIGN KEY FK_1FD775664FFA550E
        SQL);
        $this->addSql(<<<'SQL'
